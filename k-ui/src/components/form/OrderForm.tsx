...
export function OrderForm({
	...
	async function onSubmit(values: z.infer<typeof formSchema>) {
		...
		// 		product: {
		// 			id: values.inventory.product.id,
		// 			price: values.inventory.product.price
		// 		},
		// 		warehouse: {
		// 			id: values.inventory.warehouse.id,
		// 			name: values.inventory.warehouse.name
		// 		}
		// 	},
		// 	quantity: values.quantity,
		// 	orderDate: values.orderDate,
		// 	perItemCost: values.perItemCost
		// }
