/**
 * Uses DefaultForm.jsx to create a OrderForm with custom input fields.
 * Has two main functions:
 * 1. Allows user to create order and add to the database.
 * 2. Allows user to edit existing order and update to the database.
 * 
 * NOTE: OrderForm functions are based on input it receives.
 * Its function converts from CREATE to EDIT if a orderId input is received.
 */
